...
public class Duban_Yiban extends HeadBaseActivity {
    ...
    protected void initView(RelativeLayout headView, RelativeLayout backBtn, RelativeLayout headerCenter,
        ...
        ((TextView) headerCenter.getChildAt(0)).setText("督办流程");
        initThisView();
    }
    ...
    private void RequestServer() {
        ...
        Queue.add(1, request, new OnResponseListener<ProcessShenheHistoryRes>() {
            ...
            public void onFailed(int what, Response<ProcessShenheHistoryRes> response) {
                Toast.makeText(Duban_Yiban.this, "请求数据失败", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onSucceed(int what, Response<ProcessJieguoResponse> response) {
                if (null != response && null != response.get()) {
                    if (response.get().getCode() == 200) {
                        Toast.makeText(Duban_Yiban.this, "流程审核成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
                    Toast.makeText(Duban_Yiban.this, "流程审核失败", Toast.LENGTH_SHORT).show();
                }
            }
...
//        if (!TextUtils.isEmpty(yijian)) {
            ...
            Queue.add(0, request, new OnResponseListener<ProcessJieguoResponse>() {
                ...
                public void onSucceed(int what, Response<ProcessJieguoResponse> response) {
                    if (null != response && null != response.get()) {
                        if (response.get().getCode() == 200) {
                            Toast.makeText(Duban_Yiban.this, "退回成功", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }
    ...
    public void chooseDate2(final List<ChildrenBean> data, final TextView tempTv, final String title) {
        ...
        mxxDialog2 = new XXDialog(this, R.layout.dialog_chooselist) {
            ...
            public void convert(DialogViewHolder holder) {
                ...
                xxre.setLayoutManager(new LinearLayoutManager(Duban_Yiban.this));
                List<ChildrenBean> datas = new ArrayList();
                final CommonRecyclerAdapter<ChildrenBean> adapter = new CommonRecyclerAdapter<ChildrenBean>(Duban_Yiban.this,
            ...
            public void onSucceed(int what, Response<ZuzhiUserListResponse> response) {
                ...
                if (null != response && null != response.get() && null != response.get().getData()) {
                    ...
                    if (tempdata.size() > 0) {
                        ...
                        Toast.makeText(Duban_Yiban.this, "没有查到相关人员", Toast.LENGTH_LONG).show();
                    }
                }
            }
    ...
    public void chooseUsersDate(final List<ZuzhiUserBean> data, final TextView tv, final String title) {
        mxxUsersDialog = new XXDialog(this, R.layout.dialog_chooselist) {
            ...
            public void convert(DialogViewHolder holder) {
                ...
                final CommonRecyclerAdapter<ZuzhiUserBean> adapter = new CommonRecyclerAdapter<ZuzhiUserBean>(Duban_Yiban.this,
                        datas, R.layout.simple_list_item) {
                    @Override
                ...
                adapter.setOnItemClickListener(new CommonRecyclerAdapter.OnItemClickListener() {
                    ...
                    public void onItemClickListener(CommonViewHolder commonViewHolder, int i) {
                        ...
                        if ("-1".equals(id)) {
                            Toast.makeText(Duban_Yiban.this, "没有查到相关人员", Toast.LENGTH_SHORT).show();
                        } else {
                            banlirenId = id;
