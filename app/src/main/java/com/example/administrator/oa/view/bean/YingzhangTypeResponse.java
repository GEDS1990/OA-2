...
public class YingzhangTypeResponse {
    ...
    private int code;
    private List<YingzhangTypeBean> data;
    ...
    public List<YingzhangTypeBean> getData() {
        return data;
    }

    public void setData(List<YingzhangTypeBean> data) {
        this.data = data;
    }
