...
public class YongyinApplyActivity_shenhe extends HeadBaseActivity {
...
//    TextView mFenguanleader;
    ...
    protected int getChildLayoutRes() {
        return R.layout.activity_yongyin_apply_shenhe;
    }

    @Override
    protected void initView(RelativeLayout headView, RelativeLayout backBtn, RelativeLayout headerCenter,
                            RelativeLayout headerRight, View childView, LinearLayout statubar) {
        ((TextView) headerCenter.getChildAt(0)).setText("用印审核单");
        initThisView();
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_fujian:
                ...
                if(!TextUtils.isEmpty(mFilePathReturn)){
                    ...
                    FileUtils.openLocalFile(YongyinApplyActivity_shenhe.this, mFilePath);
                }
                break;
    ...
    private void RequestServer() {
        ...
        Queue.add(1, request, new OnResponseListener<ProcessShenheHistoryRes>() {
            ...
            public void onFailed(int what, Response<ProcessShenheHistoryRes> response) {
                Toast.makeText(YongyinApplyActivity_shenhe.this, "请求数据失败", Toast.LENGTH_SHORT).show();
            }
                        ...
                        if(!TextUtils.isEmpty(bean.getName()) && !TextUtils.isEmpty(bean.getValue())) {
                            ...
                            switch (label) {
                                ...
                                case "fileupload":
                                    if(!TextUtils.isEmpty(bean.getLabel())) {
                                        // 实时请求权限
                                        CommonUtil.verifyStoragePermissions(YongyinApplyActivity_shenhe.this);
                                        mAddFujian.setTag("1");
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUESTCODE_FROM_ACTIVITY) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {//4.4以后
                    path = FileUtils.getPath(YongyinApplyActivity_shenhe.this, uri);
                } else {//4.4以下下系统调用方法
                    path = FileUtils.getRealPathFromURI(YongyinApplyActivity_shenhe.this, uri);
                }
    ...
    private void RequestServerForViewFile() {
        ...
        ProcessQueue.add(0, request, new OnResponseListener<FilePreviewResponse>() {
                ...
                if (null != response && null != response.get()) {
                    if (response.get().getCode() == 200) {
                        if(null != response.get().getData()) {
                            FileUtils.openWebFile(YongyinApplyActivity_shenhe.this, response.get().getData().getViewurl());
                        }
                    }
                }
            }
            ...
            public void onFailed(int what, Response<FilePreviewResponse> response) {
                Toast.makeText(YongyinApplyActivity_shenhe.this, "预览失败", Toast.LENGTH_SHORT).show();
            }
    ...
    private void RequestServerUploadFile(String picpath, String filename) {
        ...
        ProcessQueue.add(1, request, new OnResponseListener<ProcessJieguoResponse>() {
            ...
            public void onSucceed(int what, Response<ProcessJieguoResponse> response) {
                ...
                if (null != response && null != response.get() && null != response.get().getData()) {
                    Toast.makeText(YongyinApplyActivity_shenhe.this, "上传成功", Toast.LENGTH_SHORT).show();
//                mBtnCancel.setVisibility(View.VISIBLE);
            ...
            public void onFailed(int what, Response<ProcessJieguoResponse> response) {
                Toast.makeText(YongyinApplyActivity_shenhe.this, "上传失败", Toast.LENGTH_SHORT).show();
            }
    ...
    private void RequestServerDownLoad(){
        ...
        downloadQueue.add(0, downloadRequest, new DownloadListener() {
            ...
            public void onDownloadError(int what, Exception exception) {
                ...
                Toast.makeText(YongyinApplyActivity_shenhe.this, "附件下载失败", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFinish(int what, String filePath) {
                ...
                Toast.makeText(YongyinApplyActivity_shenhe.this, "附件下载完成", Toast.LENGTH_SHORT).show();
...
//                .append("\"fgld_name\":" + "\"" + fenguanleader + "\",")
        ...
        Queue.add(0, requestCommit, new OnResponseListener<ProcessJieguoResponse>() {
            ...
            public void onSucceed(int what, Response<ProcessJieguoResponse> response) {
                if (null != response && null != response.get()) {
                    if (response.get().getCode() == 200) {
                        Toast.makeText(YongyinApplyActivity_shenhe.this, "流程审核成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            }
            ...
            @Override
            public void onFailed(int what, Response<ProcessJieguoResponse> response) {
                Toast.makeText(YongyinApplyActivity_shenhe.this, "流程审核失败", Toast.LENGTH_SHORT).show();
            }
...
//        if (!TextUtils.isEmpty(yijian)) {
            ...
            Queue.add(0, request, new OnResponseListener<ProcessJieguoResponse>() {
                ...
                public void onSucceed(int what, Response<ProcessJieguoResponse> response) {
                    if (null != response && null != response.get()) {
                        if (response.get().getCode() == 200) {
                            Toast.makeText(YongyinApplyActivity_shenhe.this, "退回成功", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }
