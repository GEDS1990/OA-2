...
public class CaoGaoXiangListBean {
    ...
    private List<CaoGaoXiangInfoBean> data;
    ...
    public List<CaoGaoXiangInfoBean> getData() {
        return data;
    }

    public void setData(List<CaoGaoXiangInfoBean> data) {
        this.data = data;
    }
