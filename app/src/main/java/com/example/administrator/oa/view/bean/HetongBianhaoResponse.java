...
public class HetongBianhaoResponse {
    ...
    private int code;
    private List<HetongBianhaoBean> data;
    ...
    public List<HetongBianhaoBean> getData() {
        return data;
    }

    public void setData(List<HetongBianhaoBean> data) {
        this.data = data;
    }
